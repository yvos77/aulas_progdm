...
} ? NavigatorScreenParams<StaticParamList<T['screen']>> | undefined : T extends {
    config: StaticConfig<NavigatorTypeBagBase>;
} ? NavigatorScreenParams<StaticParamList<T>> | undefined : UnknownToUndefined<ParamsForScreenComponent<T>>;
 ...
 */
export declare function createComponentForStaticConfig<T extends {
 ...
 */
export declare function createComponentForStaticConfigDeprecated(tree: StaticNavigation<any, any, any>): React.ComponentType<{}>;
