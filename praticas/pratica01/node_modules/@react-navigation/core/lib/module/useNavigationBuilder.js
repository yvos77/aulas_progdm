...
export function useNavigationBuilder(createRouter, options) {
  ...
  const isNestedParamsConsumed = typeof route?.params === 'object' && route.params != null ? consumedParams?.ref?.deref() === route.params : false;
  const {
    children,
    layout,
    screenOptions,
  ...
  React.useEffect(() => {
    if (setConsumedParamsRef && didConsumeNestedParams && typeof route?.params === 'object' && route.params != null) {
