 ...
 */
export function createComponentForStaticConfig(tree, displayName) {
  const {
    Navigator,
    Group,
    Screen,
 ...
 */
export function createComponentForStaticConfigDeprecated(tree) {
  console.warn('`createComponentForStaticConfig` is deprecated. Use `tree.getComponent()` instead.');
