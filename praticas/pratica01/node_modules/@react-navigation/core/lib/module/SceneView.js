...
export function SceneView({
  ...
  const [consumedParamsRef, setConsumedParamsRef] = React.useState(null);
  const consumedParamsContext = React.useMemo(() => ({
    ref: consumedParamsRef,
    setRef: setConsumedParamsRef
  }), [consumedParamsRef]);
  ...
  return /*#__PURE__*/_jsx(ConsumedParamsContext.Provider, {
